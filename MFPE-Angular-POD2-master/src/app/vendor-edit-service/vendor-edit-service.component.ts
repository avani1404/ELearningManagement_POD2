...
@Component({
  selector: 'app-vendor-edit-service',
  templateUrl: './vendor-edit-service.component.html',
  styleUrls: ['./vendor-edit-service.component.css']
})
export class VendorEditServiceComponent implements OnInit {
  ...
  onEdit(){
   ...
   // if(this.res == "Saved")
      ...
      this.router.navigate(['v_layout/edit_service_form']);
